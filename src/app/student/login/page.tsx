...
export default function StudentOTPLoginPage() {
          ...
          {step === 1 ? (
            <form onSubmit={handleRequestOTP}>
              <div style={{ marginBottom: '1.25rem' }}>
                <label style={{ color: '#94a3b8', fontSize: '0.75rem', display: 'block', marginBottom: '0.5rem' }}>STUDENT EMAIL</label>
              ...
              <button type="submit" disabled={loading} style={{ width: '100%', backgroundColor: '#00f0ff', color: '#020617', padding: '0.75rem', border: 'none', borderRadius: '4px', fontWeight: 'bold', cursor: 'pointer' }}>
                {loading ? "GENERATING..." : "DISPATCH STUDENT OTP"}
              </button>
            </form>
          ) : (
